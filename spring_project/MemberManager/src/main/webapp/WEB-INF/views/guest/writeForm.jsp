      ...
      <div class="my-3 p-3 bg-white rounded box-shadow">
        ...
        <div class="text-muted pt-3">
          ...
          <div class="form-group">
          	...
          	<input type="number"  class="form-control" id="writer" name="writer" aria-describedby="emailHelp">
          </div>
          <div class="form-group">
          	<label for="title">제목</label>
          	<input type="number"  class="form-control" id="title" name="title" aria-describedby="emailHelp">
          </div>
          <div class="form-group">
