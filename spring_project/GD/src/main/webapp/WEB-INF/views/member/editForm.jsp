      ...
      <div class="my-3 p-3 bg-white rounded box-shadow">
        ...
        <div class=" text-muted pt-3">
          ...
          <div class="form-group">
          	...
          	<input type="text"  class="form-control" id="uid" name="uid" readonly value="${editData.uid}">
          </div>
          ...
          <div class="form-group">
          	...
          	<input type="text" class="form-control" id="uname" name="uname" required value="${editData.uname}">          	
          </div>
          ...
          <div class="form-group">	         
	          ...
	          <div  class="form-check form-check-inline">
	          	...
	          	<input type="radio" class="form-check-input" id="gender" name="gender" value="M" required <c:if test="${editData.gender=='M'}">checked</c:if> >
	          	 
	          	 
	          	<label for="title" class="form-check-label">여자</label>
	          	<input type="radio" class="form-check-input" id="gender" name="gender" value="F" required <c:if test="${editData.gender=='F'}">checked</c:if> >          	
	          </div>
          	</div>          	          	
          </div>
          ...
          <div class="form-group">
          	<label for="title">이전 사진 파일</label>          	
          	<input type="text" class="form-control" name="oldFile" value="${editData.uphoto}">         	
          </div>
