	...
	<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
		...
		<div class="navbar-collapse offcanvas-collapse"
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link" href="<c:url value="/map/map"/>">지도</a></li>
				<li class="nav-item"><a class="nav-link" href="<c:url value="/air/temp"/>">날씨</a></li>
				<li class="nav-item"><a class="nav-link" href="<c:url value="/ocean/ocean"/>">바다</a></li>
				<li class="nav-item"><a class="nav-link" href="<c:url value="/weather/weather"/>">날씨</a></li>
